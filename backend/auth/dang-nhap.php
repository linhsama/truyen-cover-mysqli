        ...
        <?php 
           ...
           error_reporting(E_ALL);
            ...
            if(isset($_POST['login'])){
                ...
                $sql = <<<EOT
                    SELECT * FROM tai_khoan WHERE ten_tai_khoan = '$ten_tai_khoan' AND mat_khau='$mat_khau' AND trang_thai = '1' AND phan_quyen = '2'
EOT; 
                ...
                if(isset($data)){
                    ...
                    echo "<script> location.href='/truyen-cover/index.php';</script>";
            ...
            <div id="user-center">
                ...
                <div class="box">
                    ...
                    <div class="form-group text-center">
                        ...
                        Bạn đã chưa có tài khoản? <a href="/truyen-cover/backend/auth/dang-ky.php"><b>Đăng ký</b></a>
                    </div>
                </div>
            </div>
    </div>
