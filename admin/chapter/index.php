                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">
                                    <a href="them.php?truyen_id=<?=$data[0]['truyen_id']?>">
                            ...
                            <tr>
                                ...
                                <td class="text-center font-weight-bold">
                                    <div class="btn-group btn-group-sm">
                                        <a href="../chapter-noi-dung/index.php?chapter_id=<?=$item['chapter_id']?>&truyen_id=<?=$item['truyen_id']?>"
                                            class="btn btn-secondary mr-2"><i class="fa-regular fa-file-image"></i>
                                            Cập nhật nội dung</a>
                                        <a href="sua.php?chapter_id=<?=$item['chapter_id']?>&truyen_id=<?=$item['truyen_id']?>"
