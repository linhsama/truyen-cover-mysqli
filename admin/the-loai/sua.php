            ...
            <div class="head-title">
                <div class="left">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a class="active"
                                href="/truyen-cover/admin/the_loai/sua.php?the_loai_id=<?=$data_old["the_loai_id"]?>">Cập
                                nhật thể loại</a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="add-update">
                        ...
                        <form class="add-update-list" id="frm_update_the_loai" action="" method="post">
                            ...
                            <div class="col">
                                ...
                                <textarea class="form-control" id="the_loai_mo_ta" name="the_loai_mo_ta"><?= $data_old['the_loai_mo_ta']?></textarea>
                            </div>
                            <br />
                            <div class="col text-center">
                                <button type="submit" class="btn btn-primary" id="btn_update_the_loai"
                                    name="btn_update_the_loai"><i class="fa-solid fa-floppy-disk"></i> Lưu thông tin</button>
                            </div>
                        </form>
                        <?php endif?>
                        <!-- end form nhập liệu -->
